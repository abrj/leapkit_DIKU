...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'students_student', (
            ...
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='student_country', null=True, to=orm['geographic_info.Country'])),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='student_region', null=True, to=orm['geographic_info.Region'])),
            ('zip_code', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='student_zipcode', null=True, to=orm['geographic_info.ZipCode'])),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='student_city', null=True, to=orm['geographic_info.City'])),
            ('street', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='student_street', null=True, to=orm['geographic_info.Street'])),
            ('institution', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.Institution'])),
            ('department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.Department'], null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'students', ['Student'])

        # Adding M2M table for field courses on 'Student'
        m2m_table_name = db.shorten_name(u'students_student_courses')
        ...
        db.create_table(u'students_studentproject', (
            (u'project_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Project'], unique=True, primary_key=True)),
            ('project_owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['students.Student'])),
        ))
        db.send_create_signal(u'students', ['StudentProject'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'students_student_courses'))
        ...
        db.delete_table(u'students_studentproject')
    ...
    models = {
        ...
        u'students.student': {
            ...
            'line_of_study': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['institutions.FieldOfStudy']", 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
