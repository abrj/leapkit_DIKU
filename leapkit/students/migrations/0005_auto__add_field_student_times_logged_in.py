...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.times_logged_in'
        db.add_column(u'students_student', 'times_logged_in',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.times_logged_in'
        db.delete_column(u'students_student', 'times_logged_in')
    ...
    models = {
        ...
        u'institutions.fieldofstudy': {
            'Meta': {'ordering': "['name']", 'object_name': 'FieldOfStudy'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'institutions.institution': {
            'Meta': {'ordering': "('short_name', 'name')", 'object_name': 'Institution'},
        ...
        u'students.student': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'education_level': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
            ...
            'times_logged_in': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
