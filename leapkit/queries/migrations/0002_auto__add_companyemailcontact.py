...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyEmailContact'
        db.create_table(u'queries_companyemailcontact', (
        ...
        db.send_create_signal(u'queries', ['CompanyEmailContact'])


    def backwards(self, orm):
        # Deleting model 'CompanyEmailContact'
        db.delete_table(u'queries_companyemailcontact')
