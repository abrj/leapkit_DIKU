...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.students_needed'
        db.alter_column(u'projects_project', 'students_needed', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.students_needed'
        db.alter_column(u'projects_project', 'students_needed', self.gf('django.db.models.fields.IntegerField')(default=1))
