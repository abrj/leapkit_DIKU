...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.project_document_description'
        db.add_column(u'projects_project', 'project_document_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.project_document_description'
        db.delete_column(u'projects_project', 'project_document_description')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'project_document_description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
