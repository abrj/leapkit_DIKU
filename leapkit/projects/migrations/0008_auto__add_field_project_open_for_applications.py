...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.open_for_applications'
        db.add_column(u'projects_project', 'open_for_applications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.open_for_applications'
        db.delete_column(u'projects_project', 'open_for_applications')
