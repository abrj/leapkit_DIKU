...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.project_length'
        db.delete_column(u'projects_project', 'project_length')


    def backwards(self, orm):
        # Adding field 'Project.project_length'
        db.add_column(u'projects_project', 'project_length',
