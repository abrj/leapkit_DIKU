...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobFunction'
        db.create_table(u'projects_jobfunction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=254)),
        ))
        db.send_create_signal(u'projects', ['JobFunction'])

        # Adding M2M table for field job_functions on 'Project'
        m2m_table_name = db.shorten_name(u'projects_project_job_functions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'projects.project'], null=False)),
            ('jobfunction', models.ForeignKey(orm[u'projects.jobfunction'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'jobfunction_id'])


    def backwards(self, orm):
        # Deleting model 'JobFunction'
        db.delete_table(u'projects_jobfunction')

        # Removing M2M table for field job_functions on 'Project'
        db.delete_table(db.shorten_name(u'projects_project_job_functions'))
