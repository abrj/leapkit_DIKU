...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.project_type'
        db.alter_column(u'projects_project', 'project_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):

        # Changing field 'Project.project_type'
        db.alter_column(u'projects_project', 'project_type', self.gf('django.db.models.fields.CharField')(default='S', max_length=1))
