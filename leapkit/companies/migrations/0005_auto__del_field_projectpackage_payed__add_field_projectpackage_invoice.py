...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectPackage.payed'
        db.delete_column(u'companies_projectpackage', 'payed')

        # Adding field 'ProjectPackage.invoice_sent'
        db.add_column(u'companies_projectpackage', 'invoice_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectPackage.payment_recieved'
        db.add_column(u'companies_projectpackage', 'payment_recieved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectPackage.payed'
        db.add_column(u'companies_projectpackage', 'payed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ProjectPackage.invoice_sent'
        db.delete_column(u'companies_projectpackage', 'invoice_sent')

        # Deleting field 'ProjectPackage.payment_recieved'
        db.delete_column(u'companies_projectpackage', 'payment_recieved')
    ...
    models = {
        ...
        u'companies.projectpackage': {
            ...
            'payment_recieved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
