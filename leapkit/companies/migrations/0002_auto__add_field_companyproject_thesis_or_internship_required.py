...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProject.thesis_or_internship_required'
        db.add_column(u'companies_companyproject', 'thesis_or_internship_required',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProject.thesis_or_internship_required'
        db.delete_column(u'companies_companyproject', 'thesis_or_internship_required')
