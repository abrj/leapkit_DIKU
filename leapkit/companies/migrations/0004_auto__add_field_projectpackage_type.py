...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectPackage.type'
        db.add_column(u'companies_projectpackage', 'type',
                      self.gf('django.db.models.fields.CharField')(default='ST', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectPackage.type'
        db.delete_column(u'companies_projectpackage', 'type')
