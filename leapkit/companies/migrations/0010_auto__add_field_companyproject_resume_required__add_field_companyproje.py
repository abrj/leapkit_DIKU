...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProject.resume_required'
        db.add_column(u'companies_companyproject', 'resume_required',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'CompanyProject.open_for_applications'
        db.add_column(u'companies_companyproject', 'open_for_applications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProject.resume_required'
        db.delete_column(u'companies_companyproject', 'resume_required')

        # Deleting field 'CompanyProject.open_for_applications'
        db.delete_column(u'companies_companyproject', 'open_for_applications')
