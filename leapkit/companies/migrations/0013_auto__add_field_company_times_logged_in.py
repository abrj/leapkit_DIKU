...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.times_logged_in'
        db.add_column(u'companies_company', 'times_logged_in',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.times_logged_in'
        db.delete_column(u'companies_company', 'times_logged_in')
