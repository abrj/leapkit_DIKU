...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectPackage.payment_received'
        db.add_column(u'companies_projectpackage', 'payment_received',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProjectPackage.payment_received'
        db.delete_column(u'companies_projectpackage', 'payment_received')
