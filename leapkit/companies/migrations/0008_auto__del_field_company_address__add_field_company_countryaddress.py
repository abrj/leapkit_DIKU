...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.countryaddress'
        db.add_column(u'companies_company', 'countryaddress',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Company.countryaddress'
        db.delete_column(u'companies_company', 'countryaddress')
    ...
    models = {
        ...
        u'companies.company': {
            ...
            'countryaddress': ('django.db.models.fields.CharField', [], {'max_length': '254', 'blank': 'True'}),
