...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Company.street'
        db.delete_column(u'companies_company', 'street_id')

        # Deleting field 'Company.city'
        db.delete_column(u'companies_company', 'city_id')

        # Deleting field 'Company.zip_code'
        db.delete_column(u'companies_company', 'zip_code_id')

        # Adding field 'Company.address'
        db.add_column(u'companies_company', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Company.street'
        db.add_column(u'companies_company', 'street',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='company_street', null=True, to=orm['geographic_info.Street'], blank=True),
                      keep_default=False)

        # Adding field 'Company.city'
        db.add_column(u'companies_company', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='company_city', null=True, to=orm['geographic_info.City'], blank=True),
                      keep_default=False)

        # Adding field 'Company.zip_code'
        db.add_column(u'companies_company', 'zip_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='company_zipcode', null=True, to=orm['geographic_info.ZipCode'], blank=True),
                      keep_default=False)

        # Deleting field 'Company.address'
        db.delete_column(u'companies_company', 'address')
